...
<p align="center">
  <a href="https://github.com/EvolutionAPI/evo-ai-core-service-community/releases/latest"><img src="https://img.shields.io/github/v/release/EvolutionAPI/evo-ai-core-service-community?include_prereleases&label=version&color=00ffa7" alt="Latest version" /></a>
...
Evo CRM Core Service is part of the [Evo CRM Community](https://github.com/EvolutionAPI/evo-crm-community) ecosystem maintained by Evolution Foundation. To use the full stack, clone the umbrella repository with submodules:
...
```bash
git clone git@github.com:EvolutionAPI/evo-ai-core-service-community.git
